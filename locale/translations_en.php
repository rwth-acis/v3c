...
function getLanguage()
{
    return array(
        ...
        "addcourse:placeholder:profession" => "Enter your course profession",
        "addcourse:content:desription" => "Description:",
        "addcourse:placeholder:description" => "Enter course description",

        "course:content:courseunits" => "Course Units",
        "course:content:enterroom" => "Enter Course Room",
        ...
        "editcourse:edit:domain" => "Course Domain:",
