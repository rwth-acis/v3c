            ...
            <div class='row'>
                <div class='col-md-10 col-md-offset-1'>
                    ...
                    <div class='featured-box'>
                        Enter course name, contact, description and dates below. Click "+" to set up your own course
                        room. If you would like help on how to set up a course room, press the "?" button.<br>
                        To show models in your course room, add models on the right side. You can delete models by
                        pressing the red "x". Those models will not be shown in your course room.<br>
                    ...
                    <form role="form"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="col-xs-10 form-control" rows="1" name="roleLink" id="targetRole"
                                   placeholder="Enter ROLE space name" value="<?php echo $entry['role_url']; ?>">
                            <a href="#">
                                <input id="create-room-btn" class="col-xs-1 btn btn-default btn-inline" type="button"
                                       value="+"/>
                            </a>
