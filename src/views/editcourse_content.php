...
try {
    $entry = getSingleDatabaseEntryByValuePair('courses', 'id', $course_id, 'lang', $course_lang);
} catch (Exception $e) {
            ...
            <div class='row'>
                <div class='col-md-10 col-md-offset-1'>
                    ...
                    <div class='featured-box'>
                        Change you course room information. Don't forget to click the save button.
                    </div>
                    ...
                    <form role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="targetLang" value="<?php echo $course_lang; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="domain" width="80">
                                    <?php foreach ($subjects as $subject) {
                                        echo "<option value=" . $subject['id'];
                                        if ($subject['id'] === $entry['domain']) {
                                            echo " selected";
                                        }
