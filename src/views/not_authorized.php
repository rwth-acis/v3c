        ...
        case USER_STATUS::USER_NOT_CONFIRMED:
            ...
            <div class="featured-box" id="div_lecturer_registration">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-default btn-block" data-loading-text="Upgrading..."
                                    id="btn_request_lecturer">Upgrade to lecturer account
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <p>
                    ...
                    When clicking the "Upgrade to lecturer account" button, we will upgrade your account to a lecturer
                    account. Once your account has been upgraded, you will be informed by mail.
                </p>
                <p>
                    <b>What benefits do I have when using a lecturer account?</b><br>
                    A lecturer account is required for creating your own courses, uploading models and presenting models
                    in lecturer mode.
                </p>
            </div>
            <?php
